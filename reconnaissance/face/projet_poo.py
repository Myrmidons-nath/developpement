...
class detections_face:
    def __init__(self):
        ...
        self.face_detection = self.mp_face.FaceDetection(0.75)
    def detect(self, frame):
        ...
        if results.detections:
            for id, detection in enumerate(results.detections):
                ...
                cv2.putText (frame, f'{int (detection.score[0] * 100)}%', (bbox[0], bbox [1] - 20), cv2.FONT_HERSHEY_PLAIN, 3, (255, 255, 0), 2)
